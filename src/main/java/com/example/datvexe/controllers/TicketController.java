...
public class TicketController {
    ...
    public DataResponse addTicket (@RequestBody TicketRequest ticketRequest){
        ...
        DataResponse dataResponse = TicketService.addTicket(ticketRequest);
    ...
    public DataResponse updateTicket(@PathVariable("id") String id,@RequestBody TicketRequest ticketRequest){
        if(ticketRequest == null || id==null) throw new CustomException("400","Missing field!!!");
        Long Ticket id = Long.valueOf(id);
        Ticket ticket = TicketService.updateTicket(ticketRequest,ticketId);
    ...
    public DataResponse deleteTicket (@PathVariable("id") String id){
        ...
        return new DataResponse("200", "Xoa thanh cong ve xe id: " + ticketId);
    }
}
